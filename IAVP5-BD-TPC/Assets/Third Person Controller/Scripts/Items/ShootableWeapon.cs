    ...
    public class ShootableWeapon : Weapon, IReloadableItem, IFlashlightUseable, ILaserSightUseable
    {
        ...
        protected virtual void HitscanFire()
        {
            ...
            if (Physics.Raycast(m_FirePoint.position, fireDirection, out m_RaycastHit, m_HitscanFireRange, m_HitscanImpactLayers.value, QueryTriggerInteraction.Collide)) {
                ...
                if (m_RaycastHit.collider.gameObject.CompareTag("Ghost"))
                {
                    Debug.Log("AAA");
                   m_RaycastHit.collider.gameObject.transform.position = new Vector3(Random.Range(-30, 30), Random.Range(0, 15), Random.Range(-30, 30));
                }
